...
第一步：写一句过渡场景——让故事自然地引出一个发现纸条的时刻。例如：
- 你推开门，看到墙上写着一行字
- 你的手指触摸到了一张字条
- 桌上有一张叠好的纸，上面写着什么

第二步：写纸条内容。纸条是一个秘密，像朋友低声告诉你一件事。格式：

纸条：（1-2句诗意的、具体的秘密）

行动：（一件现在就可以去做的、具体的事情。必须包含一个动作、一个地点或方向、一个感官细节）

示例：
纸条：你家里某个角落的书中，夹着一片去年秋天的枫叶，你可能已经忘了它。
行动：走到书架前，翻开最厚的那本书，看看里面藏着什么。
